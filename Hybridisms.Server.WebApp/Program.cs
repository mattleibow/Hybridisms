...
builder.Services.AddScoped<DbLabelRecommendationService>();
builder.Services.AddScoped<ILabelRecommendationService, DbLabelRecommendationService>(svc => svc.GetRequiredService<DbLabelRecommendationService>());
