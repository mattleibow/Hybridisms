...
public static class AspireAppSettings
{
    public static readonly Dictionary<string, string> Settings =
        new Dictionary<string, string>
        {
            ...
            ["DOTNET_LAUNCH_PROFILE"] = "Hybridisms.Client.WebAssembly.ClientStub",
            ["DOTNET_SYSTEM_CONSOLE_ALLOW_ANSI_COLOR_REDIRECTION"] = "true",
            ["ENVIRONMENT"] = "Development",
            ["LAUNCH_PROFILE"] = "Hybridisms.Client.WebAssembly.ClientStub",
            ...
            ["OTEL_RESOURCE_ATTRIBUTES"] = "service.instance.id=wccvjngr",
            ["OTEL_SERVICE_NAME"] = "wasm",
